...
$confirmation = Read-Host "Are you Sure You Want To Clear cache of appveyor project oldratlee/auto-pipeline"
...
Invoke-RestMethod -Uri 'https://ci.appveyor.com/api/projects/oldratlee/auto-pipeline/buildcache' -Headers $headers -Method Delete
